...
public class StencilUtils
{
    ...
    public static void enableStencilBuffer() {
        Creed.mc.getFramebuffer().bindFramebuffer(false);
        if (Creed.mc.getFramebuffer() != null) {
            if (Creed.mc.getFramebuffer().depthBuffer > -1) {
                setupFBO(Creed.mc.getFramebuffer());
                Creed.mc.getFramebuffer().depthBuffer = -1;
            }
        }
    ...
    public static void setupFBO(final Framebuffer framebuffer) {
        ...
        EXTFramebufferObject.glRenderbufferStorageEXT(36161, 34041, Creed.mc.displayWidth, Creed.mc.displayHeight);
        EXTFramebufferObject.glFramebufferRenderbufferEXT(36160, 36128, 36161, stencilDepthBufferID);
        EXTFramebufferObject.glFramebufferRenderbufferEXT(36160, 36096, 36161, stencilDepthBufferID);
    }

    public static void initStencil() {
        initStencil(Creed.mc.getFramebuffer());
    }
