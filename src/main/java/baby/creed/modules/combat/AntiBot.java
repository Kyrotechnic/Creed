...
import baby.creed.util.PlayerUtil;
...
public class AntiBot extends Module
{
    ...
    public static boolean isValidEntity(final Entity entity) {
        if (Creed.antiBot.isToggled() && entity instanceof EntityPlayer && entity != Creed.mc.thePlayer) {
    ...
    private static class EntityData
    {
        ...
        public void update() {
            if (this.entity instanceof EntityPlayer && Creed.mc.getNetHandler() != null && Creed.mc.getNetHandler().getPlayerInfo(this.entity.getUniqueID()) != null) {
                ++this.tabTicks;
            }
