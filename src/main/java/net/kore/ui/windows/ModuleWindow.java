...
import net.kore.util.AnimationUtil;
import net.kore.util.MouseUtils;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (!ModernClickGui.settingsOpened) {
            for (Module module : this.modulesInCategory) {
                if (module.getFlagType() == Module.FlagType.RISKY && Kore.clientSettings.hideRiskyModules.isEnabled())
                {
                    continue;
                }
