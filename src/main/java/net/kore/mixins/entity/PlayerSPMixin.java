...
import net.kore.util.PlayerUtil;
import net.kore.util.PlayerUtils;
import net.kore.util.RotationUtils;
...
public abstract class PlayerSPMixin extends AbstractClientPlayerMixin
{
    ...
    public boolean isUsingItem(final EntityPlayerSP instance) {
        return !Kore.noSlow.isToggled() && (instance.isUsingItem() || Kore.autoBlock.isBlocking());
    }
