...
public abstract class MixinItemRenderer {
    ...
    public void renderItemInFirstPerson(final float partialTicks) {
        ...
        if (this.itemToRender != null) {
            final boolean shouldSpoofBlocking = (Aura.target != null && !Kore.aura.blockMode.getSelected().equals("None")) || (!Kore.autoBlock.blockTimer.hasTimePassed((long)Kore.autoBlock.blockTime.getValue()) && Kore.autoBlock.canBlock());
