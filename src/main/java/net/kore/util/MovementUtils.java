...
public class MovementUtils
{
    ...
    public static boolean isOnGround(final double height) {
        return !Kore.mc.theWorld.getCollidingBoundingBoxes(Kore.mc.thePlayer, Kore.mc.thePlayer.getEntityBoundingBox().offset(0.0, -height, 0.0)).isEmpty();
    }
    ...
    public static void setMotion(final MoveEvent em, final double speed) {
        ...
        float yaw = ((Aura.target != null && Kore.aura.movementFix.isEnabled())) ? RotationUtils.getRotations(Aura.target).getYaw() : Kore.mc.thePlayer.rotationYaw;
